const makeRandomWithin = (max = 1, min = 0) => Math.ceil(Math.random() * (max - min + 1)) + min - 1

const generateChromosome = (chromosomesNumber, geneNumber, min, max) => new Array(chromosomesNumber)
...
const geneticCalculations = (chromosomes, options = {}, count = 0) => {
    ...
    return geneticCalculations(children, options, count)
}
